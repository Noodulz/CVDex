...
class VisionModel(nn.Module):
    def __init__(self, num_labels, resolution):
        ...
        self.linear_pooling = int(resolution / (self.num_conv_layers*2))
        super(VisionModel, self).__init__()
        self.conv1 = nn.Conv2d(3, 32, kernel_size=3, stride=1, padding=1)
        self.conv2 = nn.Conv2d(32, 64, kernel_size=3, stride=1, padding=1)

        self.linear1 = nn.Linear(64 * self.linear_pooling * self.linear_pooling, resolution*2)
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 64 * self.linear_pooling * self.linear_pooling)
